(() => {
  ...
  function buildExtractionPrompt(messages, chatState, overrides = {}) {
    ...
    return [
      ...
      "Narrative projection: spatial/positional facts only; exclude intent, emotion, opinions, social cues, and body-language interpretation unless it directly encodes position or contact.",
      "Example (positive): A sits on the chair; B stands behind A.",
      "Example (negative): A looks reluctant / displeased.",
